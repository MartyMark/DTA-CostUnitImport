...
public class Logger {
	...
	private static String buildLogText() {
	    ...
	    String runtime = Instant.ofEpochMilli(ManagementFactory.getRuntimeMXBean().getStartTime()).atZone(ZoneId.systemDefault()).toLocalDateTime().format(DTF);
